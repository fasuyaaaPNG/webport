  ...
  return (
    <div className="border bg-[#DAD5DF] h-[289px] xl:h-[342px] rounded-[12px] flex flex-row">
      ...
      <div className="secKanan xl:w-[860px] w-[632px] pt-[30px] xl:pt-[40px] pb-[40px]">
        <div className={`${chivoMono.className} flex items-center gap-[27px] xl:gap-[50px] w-max ml-[30px] mb-[29px]`}>
        ...
        <div className={`${chivoMono.className} flex flex-col justify-between ml-[30px] w-[540px] xl:w-[780px]`}>
            <p className='text-[12px] xl:text-[14px] mb-[50px] xl:mb-[80px] text-justify'>
